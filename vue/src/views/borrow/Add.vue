  ...
  <div style="width: 80%">
    ...
    <el-form :inline="true" :rules="rules" ref="ruleForm" :model="form" label-width="100px">
      <el-form-item label="图书标准码" prop="bookNo">
        <el-select v-model="form.bookNo" clearable filterable placeholder="请选择" @change="selBook"> <!-- clearable可以清除 filterable可以搜索  -->
          <el-option
              v-for="item in books"
              :key="item.id"
              :label="item.bookNo"
      ...
      <el-form-item label="图书名称" prop="bookName">
        <el-input v-model="form.bookName" disabled></el-input><!-- disabled 不可修改 -->
      </el-form-item>
      ...
      <el-form-item label="借出的天数" prop="days">
        <el-input-number v-model="form.days" :min="1" :max="30" label="借出的天数"></el-input-number><!-- 限制最大最小值 -->
      </el-form-item>
    </el-form>
    ...
    selBook() {
      ...
      * */
      ...
      request.get('/book/' + book.id).then(res => {
        this.$set(this.form, 'bookName', res.data.name) // 强制更新
